...
export interface ElementsDeliverBlock extends Schema.Component {
  collectionName: 'components_elements_deliver_blocks';
  info: {
    displayName: 'deliverBlock';
  };
  attributes: {
...
export interface LinksSocialLink extends Schema.Component {
  ...
  attributes: {
    ...
    social: Attribute.Enumeration<
      ['YOUTUBE', 'TWITTER', 'DISCORD', 'WEBSITE', 'FACEBOOK', 'LINKEDIN']
    >;
  };
}
...
export interface SectionsAnimation extends Schema.Component {
  collectionName: 'components_sections_animations';
  info: {
  ...
  attributes: {
    title: Attribute.String;
    animationName: Attribute.Enumeration<
      [
        'Development process',
        'Q-Boson builds trust',
        'Qualitia customers',
        'Product ecosystem',
        'Integrated testing',
        'CI CD'
...
export interface SectionsClickToAction extends Schema.Component {
  collectionName: 'components_sections_click_to_actions';
  info: {
    displayName: 'Click to action';
    icon: 'cursor';
    description: '';
  };
  attributes: {
...
export interface SectionsHomeHero extends Schema.Component {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    heroFeatures: Attribute.Component<'shared.input-text', true>;
    description: Attribute.Text;
  };
}
...
export interface SectionsQBosonDeliver extends Schema.Component {
  collectionName: 'components_sections_q_boson_delivers';
  info: {
    displayName: 'Q Boson deliver';
    icon: 'gift';
    description: '';
  };
  attributes: {
    title: Attribute.String;
    firstBlock: Attribute.Component<'elements.deliver-block'>;
    secondBlock: Attribute.Component<'elements.deliver-block'>;
    thirdBlock: Attribute.Component<'elements.deliver-block'>;
  };
}
...
export interface SharedInputText extends Schema.Component {
  collectionName: 'components_shared_input_texts';
  info: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      'elements.deliver-block': ElementsDeliverBlock;
      ...
      'sections.animation': SectionsAnimation;
      'sections.bottom-actions': SectionsBottomActions;
      'sections.click-to-action': SectionsClickToAction;
      ...
      'sections.q-boson-deliver': SectionsQBosonDeliver;
      'sections.rich-text': SectionsRichText;
      'sections.testimonials-group': SectionsTestimonialsGroup;
      'shared.input-text': SharedInputText;
